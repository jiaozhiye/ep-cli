 ...
 * @Last Modified time: 2020-01-28 23:53:37
 */
    ...
    class FilterTable extends Component {
      static propTypes = {
        ...
        filter: PropTypes.shape({
          type: PropTypes.string.isRequired, // 列筛选类型 text/number/range-number/date/range-date/checkbox/radio
      ...
      [`checkbox`] = (column, isServerFilter) => {
        ...
        return {
          ...
          onFilter: !isServerFilter
            ? (value, row) => {
                return _.get(row, dataIndex) === value;
              }
            : null
        };
      };
      ...
      [`text`] = (column, isServerFilter) => {
        ...
        return {
          ...
          onFilter: !isServerFilter
            ? (value, row) => {
                return _.get(row, dataIndex).includes(value);
              }
            : null
        };
      };
      ...
      render() {
        ...
        const wrapProps = Object.assign({}, rest, {
          ...
          sorter: this.sorter,
          filterOrSorterChange: this.filterOrSorterChange
        });
